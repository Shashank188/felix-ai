...
const employeeTableConfig = [
    { prop: "employeeID", label: "ID", width: 75, fixed: true },
    { prop: "lastName", label: "Last Name", width: 200, fixed: true },
    { prop: "firstName", label: "First Name", width: 175, fixed: true },
    { prop: "title", label: "Title", width: 175 },
    ...
    { prop: "reportsTo", label: "Reports To", width: 100 }
