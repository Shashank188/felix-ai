...
const customerTableConfig = [
    { prop: "customerID", label: "ID", width: 75, fixed: true },
    { prop: "companyName", label: "Name", width: 200, fixed: true },
    { prop: "contactName", label: "Contact", width: 175, fixed: true },
    { prop: "contactTitle", label: "Title", width: 175 },
    { prop: "address", label: "Address", width: 175 },
    { prop: "city", label: "City", width: 100 },
    { prop: "region", label: "Region", width: 80 },
    { prop: "postalCode", label: "Postal Code", width: 120 },
    { prop: "country", label: "Country", width: 100 },
    { prop: "phone", label: "Phone", width: 100 },
    { prop: "fax", label: "Fax", width: 150 }
]




const customerData: Array<Customer> = [
    {
        "customerID": "ALFKI",
